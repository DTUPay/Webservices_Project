Feature: Manage customers
  ...
  Scenario Outline: Requests tokens - fail
    Given a new customer with name <firstName> <lastName> and accountID <cpr> that does exist in the repository
  ...
  Scenario Outline: Requests tokens - fail
    Given a new customer with name <firstName> <lastName> and accountID <cpr> that does not exist in the repository
    When he requests more tokens
    Then an error message with <msg> is thrown
    Examples:
      | firstName | lastName | cpr           | msg                       |
  ...
  Scenario Outline: Add tokens - success
    ...
    Examples:
      | firstName | lastName | cpr          | arg0 | arg1 | arg2 |
  ...
  Scenario Outline: Add tokens - fail
    ...
    Then an error message with <msg> is thrown
    Examples:
      | firstName | lastName | cpr           | arg1 | msg |
